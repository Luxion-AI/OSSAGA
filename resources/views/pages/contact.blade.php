                ...
                <div class="lg:col-span-2 space-y-5">
                    @php
                        $contacts = [
                            ...
                            ['icon' => 'M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z', 'icon2' => null, 'title' => 'Email', 'content' => 'osis@smkn1purbalingga.sch.id'],
                            ['icon' => 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z', 'icon2' => null, 'title' => 'Telepon', 'content' => '(0281) 891-000'],
                        ];
                    @endphp
