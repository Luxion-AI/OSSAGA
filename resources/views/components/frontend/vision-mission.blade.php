        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="h-full rounded-2xl bg-gradient-to-br from-neon/15 via-surface-raised to-electric/15 border border-neon/30 p-8 relative overflow-hidden card-shine animate-pulse-glow group hover:scale-[1.02] transition-transform duration-500">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-zinc-300 leading-relaxed text-base">
                            Menjadikan OSIS SMK Negeri 1 Purbalingga sebagai organisasi yang adaptif, inovatif, dan berintegritas tinggi dalam mewujudkan siswa yang berkarakter profil pelajar Pancasila.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full">
                    @php
                        $missions = [
                            ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z"></path>', 'title' => 'Inovasi Digital', 'desc' => 'Mengoptimalkan pemanfaatan teknologi informasi dalam setiap kegiatan OSIS.'],
                            ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>', 'title' => 'Kolaborasi Aktif', 'desc' => 'Membangun sinergi antar ekstrakurikuler dan elemen sekolah.'],
                            ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path>', 'title' => 'Pengembangan Karakter', 'desc' => 'Program berfokus pada kepemimpinan dan kemandirian siswa.'],
                            ['icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path>', 'title' => 'Pelayanan Aspirasi', 'desc' => 'Menjadi wadah aspirasi siswa yang responsif dan solutif.'],
                        ];
                    @endphp
